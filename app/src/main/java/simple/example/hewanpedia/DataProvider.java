...
public class DataProvider {
    ...
    private static List<Burung> initDataBurung(Context ctx) {
        ...
        burungs.add(new Burung("Burung Cenderawasih", "indonesia",
                "Cendrawasih biasanya ditemukan di Indonesia seperti di bagian Timur Papua, Papua Nugini, pulau-pulau selat Torres, dan Australia timur.", R.drawable.burung1));
        burungs.add(new Burung("Burung hantu", "seluruh dunia kecuali antartika",
                "Burung ini termasuk golongan burung buas (karnivora, pemakan daging) dan merupakan hewan malam (nokturnal). Seluruhnya, terdapat sekitar 222 spesies yang telah diketahui, yang menyebar di seluruh dunia kecuali Antarktika, sebagian besar Greenland, dan beberapa pulau-pulau terpencil.s", R.drawable.burung2));
        burungs.add(new Burung("burung garuda", "hindu",
                "adalah salah satu makhluk antropomorfis-mitologis dalam Hinduisme, Buddhisme, dan Jainisme", R.drawable.burung3));
        burungs.add(new Burung("burung merpati", "indonesia",
                "Merpati dan dara adalah burung berbadan gempal dengan leher pendek dan paruh ramping pendek dengan cere berair. ", R.drawable.burung4));
        burungs.add(new Burung("burung beo", "indonesia",
                "Burung Beo merupakan hewan yang banyak dipelihara. Keunikan yang dimilikinya menjadi daya tarik tersendiri bagi pecinta burung. ", R.drawable.burung5));
        burungs.add(new Burung("burung bangkok", "indonesia",
                "burung berukuran sedang dari salah satu genus burung paruh bengkok, Kakatua (Cacatua). Kakatua jambul-jingga merupakan subspesies terkecil dari empat subspesies burung Kakatua-kecil Jambul-kuning ", R.drawable.burung6));
        return burungs;
    }
